...
const preloadImages = (photos: PhotoItem[]) => Promise.all(
  photos.map((photo) => new Promise<void>((resolve) => {
    const img = new Image();
    img.src = photo.src;
    if (img.complete) {
...
export const PhotoWall: React.FC<PhotoWallProps> = ({ photos }) => {
  ...
  return (
    ...
    >
      ...
      {/* 挂到 body，避免照片墙 perspective 改变 fixed 定位参照。 */}
          ...
          >
            ...
            >
              <div className="flex items-center justify-center">
                <img
                  src={selectedPhoto.preview ?? selectedPhoto.src}
